...
If users are concerned about the privacy and storage of their survey results, they can refer to LimeSurvey's response on the matter, found at \verb https://limesurvey.org/about-us/blog/2065-what-you-need-to- | \verb know-about-data-security-in-limesurvey |. Information regarding the security of data storage in the cloud with Amazon Web Services can be found at \verb https://aws.amazon.com/security |. The software license can be found at \verb https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html |. 

If the user wished to learn more about the system requirements, he or she should consult the SRS. Should the user wish to learn more about the design of the system, he or she should read the SDD. Any questions regarding the user interface will likely be answered in the UIDD. 

All questions for administration of the system should be answered in the AM. 
