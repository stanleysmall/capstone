...
The ''Publish Evaluation'' operation is used if the user has previously created an evaulation form but has yet to publish it.  The user has the ability to select on of their existing evaluations from a drop-down menu and can then choose to publish the evaluation, creating a form which will be sent out to all participants at the date entered earlier.  
...
\section{Error Messages, Warnings, and Recovery Procedures}
There are two instances in which the user will be presented with an error message or a warning.  When the user is creating a new evaluation form or editing an exist evaluation form and attempt to move on to the next page or save the form without completing all required fields they will be prevented from doing so and presented with a red error box which notifies that user of what field needs to be completed.  The user can recover from this by completing the required field and attempting to move on to the next page or save the evaluation again.

The Second warning that the user may encounter is when removing a custom question that they had previously entered.  Upon pressing the remove button on a custom question the user will be prompted to confirm that they wish to remove the question.  The user can either confirm the action by pressing 'ok' which will cause the custom question to be removed or select 'cancel' which prevent the question from being removed.
...
Stanley Small did nothing. Stan contributed about 0 percent of the document.

Jovon Craig worked on the introduction as well as the overview. Jovon contributed about 40 percent of the document.

Yuanqi Guo did some edits of the instructions section and added relevant references. Tom contributed about 10 percent of the document.

Sam Elliott added to the instructions section as well as wrote about the errors and cautions. Sam contributed about 10 percent of the document.

Robert Judkins wrote the instructions section as well as editing upon and expanding other sections. Robert contributed about 40 percent of the document.
