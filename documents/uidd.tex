...
\begin{figure}[H]
    ...
    \includegraphics[scale=.35]{images/selection_screen.png}
\end{figure}
\end{center}
...
\begin{figure}[H]
    ...
    \includegraphics[scale=.35]{images/new_form_screen.png}
\end{figure}
\end{center}
...
\begin{figure}[H]
    ...
    \includegraphics[scale=.35]{images/info_edit_screen.png}
\end{figure}
\end{center}
...
\begin{figure}[H]
    ...
    \includegraphics[scale=.35]{images/question_edit_screen.png}
\end{figure}
\end{center}
...
\begin{figure}[H]
    ...
    \includegraphics[scale=.35]{images/email_edit_screen.png}
\end{figure}
\end{center}
...
\begin{figure}[H]
    \centering
    \caption{Help screen}
    \includegraphics[scale=.35]{images/help_screen.png}
\end{figure}
\end{center}

This is the screen a user would see if they asked for help at any point in the process. It details each screen and what is being asked of the user.
