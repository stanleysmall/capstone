...
This screen details frequently asked questions a user may have and their corresponding answers.
...
This screen gives details about the product and its purpose. It also credits the creators as well as the client for whom the product was made.

\begin{center}
\begin{figure}[H]
    \centering
    \caption{Home screen}
    \includegraphics[scale=.30]{images/home_screen.png}
\end{figure}
\end{center}
...
This is the page a user would see if they decided to create a new survey. This page asks the user to fill out the general information of the course they're creating the survey for. Alternatively they can select a previously created preset rather than starting from scratch.
...
\begin{figure}[H]
    ...
    \includegraphics[scale=.30]{images/report_screen.png}
\end{figure}
\end{center}

This page is where a user would view results of their surveys, organized by each question in the survey. It includes the median, mean, standard deviation, and number of answers for each question. The results can also be downloaded and exported as a .csv file.
...
Stanley Small contributed to the discussion of the UI design. Stan contributed approximately 10 percent of the document.
