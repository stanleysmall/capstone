...
This is the main screen a user would see after logging in. Users can choose to (1) create a new evaluation form, which will redirect them to the new form screen. (2) Select a course which has been save but is unfinished and is unpublished which will redirect them to the info edit screen. (3) They can select a course that has already been published but not completed, taking them to the edit screen where information is displayed but not editable. (4) They can select a course that has been published and completed, taking them to the edit screen where information is displayed but not editable.  (5) They can select To view evaluation results, they must select a specific category type with the menu bar. Selecting a category name with the drop-down menu takes them to the results page.
...
Similar to the new form screen, a user would be redirected to this screen when choosing to edit a evaluation he or she has previously created but left unfinished or not published. The page allows users to view and edit the information of an existing unpublished evaluation form.  The ``Previous'' button redirects the user to the home page, the ``Next'' button redirects them to the question edit screen, and the ``Save'' button saves the entered information. See Appendix D for a full example of available questions to choose from.
