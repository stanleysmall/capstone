...
\begin{figure}[H]
    ...
    \includegraphics[scale=.30]{images/create_screen.png}
\end{figure}
\end{center}
...
\begin{figure}[H]
    ...
    \includegraphics[scale=.28]{images/report_screen.png}
\end{figure}
\end{center}
