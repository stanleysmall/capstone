...
\hline
.travis.yml & Defines which tests are used with continuous integration & Part of testing, not in system design document\\ 
\hline
docker-compose.yml & Defines the docker-compose command & Part of project building, not in system design document\\  
\hline
About.js & What is displayed on the about page & Part of react front end\\
\hline
App.js & Old file which ran the application, deprecated  by AppRouter.js &  Part of react front end\\  
\hline
...
\hline
CourseForm.js & Page on which users define a new evaluation & Part of react front end\\ 
\hline
EditCourse.js & Page on which users edit old courses, deprecated by CourseForm.js& Part of react front end\\ 
\hline
EnrollForm.js & Page on which users define who is to take the evaluation& Part of react front end\\ 
\hline
...
\hline
QuestionForm.js & Page on which users enter which questions they want in the evaluation & Part of react front end\\ 
\hline
Index.js & Used in construction of js app & Part of react front end\\  
\hline
insert\_mock\_data.sql & Inserts mock data in to the database& Part of testing, not in system design document\\ 
\hline
test\_teachers\_controller.py & Testing back end& Part of testing, not in system design document\\
\hline
teachers\_controller.py & processes API calls & Part of python API\\
\hline
limesurvey.py & Interfaces with Limesurvey& Part of python backend\\ 
\hline
\end{tabular}
\end{center}
