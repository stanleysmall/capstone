...
The code inspection process that Team EVAL followed was more informal than a typical Fagan inspection. In fact, our team compared the inspection meeting to a walkthrough. Our process diverged from the typical one because ours saved time, required less preparation, and allowed for a more casual atmosphere.
...
Our inspection process proved very effective. We were able to find many defects or simple fixes that may have not been caught before. It also helped us focus on continuity and consistency in our code. It was very beneficial to sit down as a team and walk through every file in our growing project. Since our project has several seperate components, it was useful for each of us to see files that we may have not contributed to.
	We were able to find defects and discuss possible solutions to them quickly. We did not waste time delving into large issues but most of our defects were quick fixes and it was important to discuss them as a team. Honestly, the process seemed beneficial enough for a team and project this size that it would be useful to do the exact same process several times throughout development.
...
\hline
Front-end modules & Other & Log-in validation ignored after authentication token generated\\ 
\hline
...
\hline
teachers\_controller.py & Correctness & Uses default MySQL username and \newline password\\ 
\hline
teachers\_controller.py & Other & MySQL password exposed in repo\\ 
\hline
